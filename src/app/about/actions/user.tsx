...
//   try {
//     const { userId, pokemon, action } = await request.json(); // 'userId' here is expected to be auth0userId

//     // 1. Input ValuserIdation and Security
//     if (!userId || typeof userId !== "string") {
//       return NextResponse.json(
//         { message: "InvaluserId user userId provuserIded" },
//         { status: 400 }
//       );
//     }
//     if (!pokemon || typeof pokemon !== "string") {
//       return NextResponse.json(
//         { message: "InvaluserId pokemon name provuserIded" },
//         { status: 400 }
//       );
//     }
//     if (!["bookmark", "liked"].includes(action)) {
//       return NextResponse.json({ message: "InvaluserId action" }, { status: 400 });
//     }
...
//       select: {
//         id: true, // Prisma's internal userId
//         auth0Id: true,
//         email:true,
//         name:true,
//         emailVerified:true,
...
//     // CRITICAL FIX: You were trying to access `userId[fieldToUpdate]`.
//     // `userId` is the auth0userId string. You need to use the `user` object you just fetched/created.
